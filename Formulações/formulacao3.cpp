 ...
 * Problem - Localização de hub com max do lucro - FORMULAÇÃO 3  
 *********************************************/
...
int main (int argc, char *argv[]){
    try{
  	...
  	// Sintaxe para o executável: make comp-form3
		
		// ========================================================================================
		// COLETAR DADOS AP  (Exemplo de sintaxe para rodar: ./form3 10LTm.txt)
		// ========================================================================================

		// alpha = 0.75; //Fator de desconto entre nós inter-hubs AP
		// 
		...
		*=============================== */
		...
		//===========================================================================
		// forall(i in 1..n, j in 1..n)  sum(k in 1..n) a[i][k] <= 1 
		//===========================================================================
		for (int i = 0; i < n; i++){
		  IloExpr r1(env);
		  for (int k = 0; k < n; k++){
  ...
  //  fprintf(re, "\n Informações Gerais: " "%s\t%d\t%1.2f\t%1.2f\t%1.2f\t%1.2f \n",  argv[1], n, alpha,  r[0][0],  s[0], g[0][0] );
	...
	//	fprintf(re, "\n lb: " "%1.2f\t \t" "ub: " "%1.2f\t \t" "gap: " "%1.2f \n", lb, ub, 100 *  gap);
		...
		//         fprintf(re, "a[%d][%d] = %f \t \t", i+1, k+1, cplex.getValue(a[i][k]));
		//   }
		// }
		// 
		// fprintf(re, "\n \n Variável b: \n \n");
		...
		// FILE *re;
		// re = fopen("ResultadosF3_AP.txt","aw+");
		// fprintf(re, "\n Informações Gerais: " "%s\t%d\t%1.2f\t%1.2f\t%1.2f\t%1.2f \n",  argv[1], n, alpha,  r[0][0],  s[0], g[0][0] );
		// fprintf(re, "\n Valor função objetivo: " "%f\t \n", (double) cplex.getObjValue ());
		// fprintf(re, "\n Tempo de CPU: " "%f\t \n", (double) crono.getTime());
		// 
